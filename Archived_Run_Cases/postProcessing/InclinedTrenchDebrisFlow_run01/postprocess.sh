...
# --- Create IsoSurface output directory ---
mkdir -p "$SCRIPT_DIR"/out/analysis/isosurface

# --- Free surface reconstruction → VTK ---
"$BIN_DIR"/IsoSurface_linux64 -dirin "$SCRIPT_DIR"/out/data -saveiso "$SCRIPT_DIR"/out/analysis/isosurface/IsoSurface
