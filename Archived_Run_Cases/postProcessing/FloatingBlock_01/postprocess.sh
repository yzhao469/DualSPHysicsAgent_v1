...
# --- Boundary/block particles → CSV (all timesteps, includes mk and positions for block tracking) ---
"$BIN_DIR"/PartVTK_linux64 -dirin "$SCRIPT_DIR"/out/data -savecsv "$SCRIPT_DIR"/out/particles/PartBoundCsv -onlytype:-all,+bound -vars:+idp,+mk
